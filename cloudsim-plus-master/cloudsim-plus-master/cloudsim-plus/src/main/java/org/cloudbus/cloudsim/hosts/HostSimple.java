...
public class HostSimple implements Host {
    ...
    private Map<Host, Long> visitedAntsLoadTable = new HashMap <Host, Long>();
    /**
    ...
    public Map<Host,Long> getvisitedAntsLoadTable(){
    	return this.visitedAntsLoadTable;
    }
    
    public void addvisitedAntsLoadTable(Host h, Long mips) {
    	this.visitedAntsLoadTable.put(h, mips);
    }
}
