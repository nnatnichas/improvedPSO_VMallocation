...
public abstract class DatacenterBrokerAbstract extends CloudSimEntity implements DatacenterBroker {
    ...
    /**
     * Get VmCreationRequestsMap map
     * @return this.vmCreationRequestMap
     */
    public Map<Vm,Datacenter> getVmCreationRequestsMap(){
    	return this.vmCreationRequestsMap;
    }
    
    public void addVmCreationRequestsMap(Vm vm, Datacenter dc) {
    	this.vmCreationRequestsMap.put(vm, dc);
    }
    ...
    protected void requestDatacenterToCreateWaitingVms(Datacenter datacenter) {
        ...
        for (final Vm vm :vmWaitingList) {
            if (!vmsToDatacentersMap.containsKey(vm) && !vmCreationRequestsMap.containsKey(vm)) {
                ...
                //send(datacenter.getId(), 5,CloudSimTags.VM_CREATE_ACK, vm);
    ...
    /**
     * get vmsToDatacentersMap map
     * @return
     */
    public Map<Vm,Datacenter> getVmsToDatacentersMap(){
    ...
    protected void addDatacenterRequestedList(Datacenter dc) {
    	this.datacenterRequestedList.add(dc);
    }
